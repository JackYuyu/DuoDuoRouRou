//
//  ABCDMineViewController.m
//  DuoDuoRouRou
//
//  Created by 林宇 on 2020/4/23.
//  Copyright © 2020 Limzoo. All rights reserved.
//
#import "ABCDMineViewController.h"
#import "ABCDMineCell.h"
#import "ABCDDDMineHeadView.h"


#import "ABCDOrderViewController.h"
#import "ABCDSettingViewController.h"
#import "ABCDAddressViewController.h"
@interface ABCDMineViewController ()
...
@implementation ABCDMineViewController
...
- (void)setTableView {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"ABCDMineCell" bundle:nil] forCellReuseIdentifier:@"ABCDMineCell"];
    [self.tableView registerClass:[ABCDDDMineHeadView class] forHeaderFooterViewReuseIdentifier:@"ABCDDDMineHeadView"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ABCDMineCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ABCDMineCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ABCDDDMineHeadView *view = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"ABCDDDMineHeadView"];
...
- (void)settingBtn:(UIButton *) btn {
    ABCDSettingViewController *vc = [ABCDSettingViewController  new];
    vc.hidesBottomBarWhenPushed = YES;
    [self.navigationController pushViewController:vc animated:YES];
