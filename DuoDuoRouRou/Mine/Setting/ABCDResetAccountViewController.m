//
//  ABCDResetAccountViewController.m
//  YanBei
//
...
#import "ABCDResetPasswordController.h"

@interface ABCDResetAccountViewController ()
...
@implementation ABCDResetAccountViewController
...
- (void)reset{
    ...
    [self.navigationController pushViewController:[ABCDResetPasswordController new] animated:YES];
}
