...
#import "ABCDOrderCell.h"
@interface ABCDOrderViewController ()
...
@implementation ABCDOrderViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[ABCDOrderCell class] forCellReuseIdentifier:@"ABCDOrderCell"];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ABCDOrderDetailViewController *vc = [ABCDOrderDetailViewController new];
