//
//  ABCDOrderDetailViewController.m
//  YanBei
//
...
#import "ABCDOrderDetailViewController.h"

#import "ABCDOrderHeadView.h"
#import "ABCDOrderDetailCell.h"
#import "ABCDOrderDetailSendInfoCell.h"

#import "ABCDGoodsDetailViewController.h"
@interface ABCDOrderDetailViewController ()

<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;

@end
@implementation ABCDOrderDetailViewController
...
- (void)setTableView {
    ...
    [self.tableView registerClass:[ABCDOrderHeadView class] forHeaderFooterViewReuseIdentifier:@"ABCDOrderHeadView"];
    [self.tableView registerClass:[ABCDOrderDetailCell class] forCellReuseIdentifier:@"ABCDOrderDetailCell"];
    [self.tableView registerClass:[ABCDOrderDetailSendInfoCell class] forCellReuseIdentifier:@"ABCDOrderDetailSendInfoCell"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        ...
        ABCDOrderDetailSendInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ABCDOrderDetailSendInfoCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ABCDOrderHeadView *view = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"ABCDOrderHeadView"];
