//
//  ABCDGoodsDetailViewController.m
//  DuoDuoRouRou
//
...
#import "ABCDAddCartView.h"
#import "ABCDGoodsInfoScrollHeadView.h"
#import "ABCDGoodsInfoImageCell.h"
@interface ABCDGoodsDetailViewController ()
...
//
@property(nonatomic,strong) ABCDAddCartView *showView;
@end

@implementation ABCDGoodsDetailViewController
...
- (void)setUI {
    ...
    [self.tableView registerClass:[ABCDGoodsInfoScrollHeadView class] forHeaderFooterViewReuseIdentifier:@"ABCDGoodsInfoScrollHeadView"];
    
    [self.tableView registerClass:[ABCDGoodsInfoImageCell class] forCellReuseIdentifier:@"ABCDGoodsInfoImageCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ABCDGoodsInfoImageCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ABCDGoodsInfoImageCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ABCDGoodsInfoScrollHeadView *view = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"ABCDGoodsInfoScrollHeadView"];
...
- (ABCDAddCartView *)showView {
    if (!_showView) {
        _showView = [[ABCDAddCartView alloc]initWithFrame:CGRectMake(0,SH, SW, 400)];
