...
#import "GoodsInfoScrollHeadView.h"
#import "GoodsInfoImageCell.h"
...
//
@property(nonatomic,strong) AddCartView *showView;
@end
...
- (void)setUI {
    ...
    [self.tableView registerClass:[GoodsInfoScrollHeadView class] forHeaderFooterViewReuseIdentifier:@"GoodsInfoScrollHeadView"];
    
    [self.tableView registerClass:[GoodsInfoImageCell class] forCellReuseIdentifier:@"GoodsInfoImageCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    GoodsInfoImageCell *cell = [tableView dequeueReusableCellWithIdentifier:@"GoodsInfoImageCell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    GoodsInfoScrollHeadView *view = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"GoodsInfoScrollHeadView"];
...
- (AddCartView *)showView {
    if (!_showView) {
        _showView = [[AddCartView alloc]initWithFrame:CGRectMake(0,SH, SW, 400)];
