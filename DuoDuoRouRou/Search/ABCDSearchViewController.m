...
#import "ABCDSearchViewController.h"
...
@implementation ABCDSearchViewController
...
- (UIViewController *)childViewController:(UIViewController *)reuseViewController forIndex:(NSInteger)index {
    ...
    if (childVc == nil) {
        ...
        ABCDSearchChildController *vc = [ABCDSearchChildController new];
        vc.index = index;
        childVc= vc;
